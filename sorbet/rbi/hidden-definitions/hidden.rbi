...
class Captions::Cue
  ALIGNMENT = ::T.let(nil, ::T.untyped)
  COLOR = ::T.let(nil, ::T.untyped)
  POSITION = ::T.let(nil, ::T.untyped)
  TEXT_PROPERTIES = ::T.let(nil, ::T.untyped)
end

module Captions::Util
  TIMECODE_REGEX = ::T.let(nil, ::T.untyped)
end

class Captions::VTT
  ALIGNMENT_VALUES = ::T.let(nil, ::T.untyped)
  AUTO_KEYWORD = ::T.let(nil, ::T.untyped)
  VTT_HEADER = ::T.let(nil, ::T.untyped)
  VTT_METADATA = ::T.let(nil, ::T.untyped)
end
